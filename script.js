// This function for "+" and "-" button to increase or decrease ticket quantity
...
// Updating subtotal and total price with tax
...
// Handle booking confirmation and error
function confirmationArea() {
    ...
    if (totalCheck == 0) {
        ...
        // Show ticket quantity and price details
